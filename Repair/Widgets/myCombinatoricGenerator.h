#ifndef __myCombinatoricGenerator_h
#define __myCombinatoricGenerator_h
...
class /*VTK_SLICER_FIDUCIALREGISTRATIONWIZARD_MODULE_LOGIC_EXPORT*/ myCombinatoricGenerator : public vtkObject //vtkAlgorithm
{
  public:
    vtkTypeMacro( myCombinatoricGenerator, vtkObject );
    static myCombinatoricGenerator* New();
  ...
  private:
    ...
    myCombinatoricGenerator(const myCombinatoricGenerator&); // Not implemented.
    void operator=(const myCombinatoricGenerator&); // Not implemented.
};
