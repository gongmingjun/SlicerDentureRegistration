...
//----------------------------------------------------------------------------
vtkStandardNewMacro( myPointDistanceMatrix );

//------------------------------------------------------------------------------
myPointDistanceMatrix::myPointDistanceMatrix()
{
...
//------------------------------------------------------------------------------
vtkPoints* myPointDistanceMatrix::GetPointList1()
{
  return this->PointList1;
}

//------------------------------------------------------------------------------
vtkPoints* myPointDistanceMatrix::GetPointList2()
{
  return this->PointList2;
}

//------------------------------------------------------------------------------
double myPointDistanceMatrix::GetDistance( int pointList1Index, int pointList2Index )
{
  if ( UpdateNeeded()  )
  {
    Update();
...
//------------------------------------------------------------------------------
void myPointDistanceMatrix::GetDistances( vtkDoubleArray* outputArray )
{
...
//------------------------------------------------------------------------------
void myPointDistanceMatrix::SetPointList1( vtkPoints* points )
{
...
//------------------------------------------------------------------------------
void myPointDistanceMatrix::SetPointList2( vtkPoints* points )
{
...
//------------------------------------------------------------------------------
void myPointDistanceMatrix::ResetDistances()
{
...
//------------------------------------------------------------------------------
void myPointDistanceMatrix::Update()
{
...
//------------------------------------------------------------------------------
bool myPointDistanceMatrix::UpdateNeeded()
{
...
//------------------------------------------------------------------------------
bool myPointDistanceMatrix::InputsContainErrors( bool verbose )
{
...
//------------------------------------------------------------------------------
void myPointDistanceMatrix::PrintSelf(ostream &os, vtkIndent indent)
{
