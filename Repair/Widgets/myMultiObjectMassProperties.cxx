...
int myMultiObjectMassProperties::RequestData(vtkInformation* vtkNotUsed(request),
...
void myMultiObjectMassProperties::TraverseAndMark(
...
//------------------------------------------------------------------------------
void myMultiObjectMassProperties::PrintSelf(ostream& os, vtkIndent indent)
{
...
vtkIdType myMultiObjectMassProperties::GetNumberOfObjects() { return this->NumberOfObjects; }

vtkTypeBool myMultiObjectMassProperties::GetAllValid() { return this->AllValid; }

double myMultiObjectMassProperties::GetTotalVolume() { return this->TotalVolume; }

double myMultiObjectMassProperties::GetTotalArea() { return this->TotalArea; }
