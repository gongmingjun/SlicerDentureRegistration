...
//----------------------------------------------------------------------------
vtkStandardNewMacro( myCombinatoricGenerator );

//------------------------------------------------------------------------------
myCombinatoricGenerator::myCombinatoricGenerator()
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::PrintSelf( std::ostream &os, vtkIndent indent )
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::PrintVectorOfVectors( std::ostream &os, vtkIndent indent, std::vector< std::vector< int > > vectorOfVectors )
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::SetCombinatoricToCartesianProduct()
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::SetCombinatoricToCombination()
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::SetCombinatoricToPermutation()
{
...
//------------------------------------------------------------------------------
std::string myCombinatoricGenerator::GetCombinatoricAsString()
{
...
void myCombinatoricGenerator::SetSubsetSize( unsigned int size )
{
  if ( size <= 0 )
  {
...
//------------------------------------------------------------------------------
unsigned int myCombinatoricGenerator::GetNumberOfInputSets()
{
  return this->InputSets.size();
}

//------------------------------------------------------------------------------
void myCombinatoricGenerator::SetNumberOfInputSets( unsigned int numSets )
{
  if ( numSets == 0 )
  {
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::AddInputSet( std::vector< int > vector )
{
  // add a deep copy
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::RemoveInputSet( unsigned int removeSetIndex )
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::ClearInputSet( unsigned int setIndex )
{
...
//------------------------------------------------------------------------------
unsigned int myCombinatoricGenerator::GetInputSetSize( unsigned int setIndex )
{
  if ( setIndex >= this->InputSets.size() )
  {
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::AddInputElement( unsigned int setIndex, int newElement )
{
  if ( setIndex >= this->InputSets.size() )
  {
    vtkGenericWarningMacro( "There is no setIndex'th set, setIndex = " << setIndex << ", number of input sets = " << this->InputSets.size() << ". Returning." );
...
//------------------------------------------------------------------------------
int myCombinatoricGenerator::GetInputElement( unsigned int setIndex, unsigned int elementIndex )
{
  if ( setIndex >= this->InputSets.size() )
  {
...
//------------------------------------------------------------------------------
std::vector< std::vector< int > > myCombinatoricGenerator::GetOutputSets()
{
...
//------------------------------------------------------------------------------
unsigned int myCombinatoricGenerator::ComputeNumberOfOutputSets()
{
  switch ( this->Combinatoric )
  {
    case COMBINATORIC_CARTESIAN_PRODUCT:
...
//------------------------------------------------------------------------------
unsigned int myCombinatoricGenerator::GetOutputSetSize()
{
  if ( this->UpdateNeeded() )
  {
    this->Update();
...
//------------------------------------------------------------------------------
int myCombinatoricGenerator::GetOutputElement( unsigned int setIndex, unsigned int elementIndex )
{
  if ( this->UpdateNeeded() )
  {
    this->Update();
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::Update()
{
  if ( !this->UpdateNeeded() )
  {
    return;
...
//------------------------------------------------------------------------------
bool myCombinatoricGenerator::UpdateNeeded()
{
  return ( this->InputChangedTime > this->OutputChangedTime );
}

//------------------------------------------------------------------------------
void myCombinatoricGenerator::UpdateCartesianProducts()
{
...
//------------------------------------------------------------------------------
unsigned int myCombinatoricGenerator::NumberOfPossibleCartesianProducts()
{
  if ( this->InputSets.size() == 0 )
  {
    return 0;
...
void myCombinatoricGenerator::UpdateCartesianProductsHelper( std::vector< int >& currentProduct, unsigned int& cartesianProductCount )
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::UpdateCombinations()
{
  // error/warning checking
  if ( !this->OutputSets.empty() )
  {
...
unsigned int myCombinatoricGenerator::NumberOfPossibleCombinations()
{
  if ( this->InputSets.size() == 0 )
  {
    return 0;
...
void myCombinatoricGenerator::UpdateCombinationsHelper( unsigned int elementIndex, std::vector< int >& currentSubset, unsigned int& combinationCount )
{
...
//------------------------------------------------------------------------------
void myCombinatoricGenerator::UpdatePermutations()
{
  // error/warning checking
  if ( !this->OutputSets.empty() )
  {
...
unsigned int myCombinatoricGenerator::NumberOfPossiblePermutations()
{
...
void myCombinatoricGenerator::UpdatePermutationsHelper( unsigned int currentSubsetSize, std::vector< int >& baseSet, unsigned int& permutationCount )
{
...
//------------------------------------------------------------------------------
unsigned int myCombinatoricGenerator::Factorial( unsigned int x )
{
  if ( x == 0 )
  {
    return 1;
