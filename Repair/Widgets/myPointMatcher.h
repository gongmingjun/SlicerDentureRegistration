#ifndef __myPointMatcher_h
#define __myPointMatcher_h
...
class /*VTK_SLICER_FIDUCIALREGISTRATIONWIZARD_MODULE_LOGIC_EXPORT*/ myPointMatcher : public vtkObject //vtkAlgorithm?
{
public:
	vtkTypeMacro(myPointMatcher, vtkObject);
	static myPointMatcher* New();
...
private:
	...
	// Not implemented:
	myPointMatcher(const myPointMatcher&);
	void operator=(const myPointMatcher&);
};
